Name of BackEndDeveloper: <Arnav Karnik>
@wisc.edu Email of BackEndDeveloper: <akarnik@wisc.edu>
Group: <JC>
Team: <red>
Files Written by Me: BackendInterface.java Backend.java ExtendedRedBlackTree.java
--------------------
...
BackendInterface.java: methods that would be enacted on the Red Black Tree
Backend.java: implemented the BackendInterface
ExtendedRedBlackTree.java: allowed there to be a search method within the
                           red black tree class by extending red black tree class
...
Helped coordinate meetings between group members, helped group members understand
my implementation with regards to the project
Signature:
----Arnav Karnik------
